...
@loader.tds
class DirXamamSecurityMod(loader.Module):
    """Control security settings (dirxam3.0.8alpha+)"""
    ...
    async def client_ready(self, client, db) -> None:
        ...
        self._is_dirxam = hasattr(self, 'inline')
    ...
    async def _add_to_group(
        ...
        if self._is_dirxam and not confirmed:
            await self.inline.form(
