...
class HelpMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            "dirxam_emoji",
            "�",
            lambda: "DirXam-only module bullet",
            "plain_emoji",
            "�",
    ...
    async def helphidecmd(self, message: Message) -> None:
        ...
        for mod in self.allmodules.modules:
            ...
            if core:
                ...
                emoji = self.config['dirxam_emoji']
            else:
        ...
        dirxam_turn = f"\n\n🌉 <b>«DirXam» - yangi o'zbekcha userboti.</b>"
        ...
        await self.inline.form(
                    text = f"{asos}{dirxam_mods}\n{''.join(core_)}{''.join(plain_)}{''.join(inline_)}" + dirxam_turn + dirxam_classic,
                    reply_markup=[
                        [{
							"text": f"{reply}", 
							"callback": "dirxamuz"
