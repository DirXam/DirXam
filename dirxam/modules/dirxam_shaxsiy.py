...
@loader.tds
class DirXamSettingsMod(loader.Module):
    """DirXam sozlamalari"""
    ...
    strings = {
        ...
        "inline_settings": "🌉 <b>Bu yerda siz DirXam sozlamalarini sozlashingiz mumkin</b>",
    ...
    async def inline__setting(self, call: CallbackQuery, key: str, state: bool) -> None:
        ...
        if key == "no_nickname" and state and self._db.get(main.__name__, "command_prefix", ".") == ".":
            await call.answer("Warning! You enabled NoNick with default prefix! You may get muted in DirXamTG chats. Change prefix or disable NoNick!", show_alert=True)
        else:
