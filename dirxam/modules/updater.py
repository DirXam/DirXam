...
class UpdaterMod(loader.Module):
    ...
    strings = {
        "name": "DirXam Yangilanish",
        "source": "<b>Manzil mavjud emas</b> <a href='{}'></a>",
        "restarting_caption": "🌍 <b>«DirXam» bazasi qayta ishga tushmoqda...</b>",
        ...
        "heroku_warning": "🏙️ <b>Heroku Api token xatoligi. </b>",
        "origin_cfg_doc": "...",
        "lavhost": "...",
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            "GIT_ORIGIN_URL",
            "https://github.com/Netuzb/DirXam",
